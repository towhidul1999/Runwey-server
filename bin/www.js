...
var app = require('../app');
var debug = require('debug')('runway-server:server');
...
app.set('port', process.env.BACKEND_IP, port);
...
function onListening() {
  ...
  var bind = typeof addr === 'string'
    ? 'pipe ' + addr
    : 'port ' + addr.port;
  console.log('Server is listening on ' + bind); // Add this line to log the server port
